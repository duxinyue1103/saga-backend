            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
              ...
              <tr>
                <td class="wrapper">
                  ...
                  <p>您可以从下方的链接中下载笔试文件，并在原文档上进行编辑。如您所申请的组别有录制试讲要求，请您仔细查看附件相关内容。<br>请您在收到笔试考核的<span class="highlight">七天内</span>将您的所有笔试文件一次性全部上传至下方提供的提交链接中，若逾期提交，我们将视为主动放弃。</p>
                  
                  <p>您的文件下载链接是: <a href="{{file_url}}">下载笔试题目</a>    ，您的文件提交链接是:  <a href="http://www.saga-xingguang.com/appreciation/volunteers/upload-writing-test?id={{id}}">提交笔试文件</a></p>
                  ...
                  <p>如果您对以上安排有任何疑问或要求，请您尽快通过邮箱或微信与我们联络，我们将与您做进一步交流。<br><span class="des-post">人事部邮箱：</span><span class="highlight-thin">human-resources@saga-xingguang.com</span><br><span class="des-post">人事部微信：</span></p>
                  <div class="signature-thin">
                    <p>顺颂，</p>
                    <p>夏祺</p>
                  </div>
                  <div class="signature-thin">
                    <p>志行会SAGA星光项目组·人事部敬上</p>
                    <p>---SAGA星光团队 </p>
                  </div>
